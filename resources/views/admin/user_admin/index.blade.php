            ...
            <div class="card-body overflow-x-auto">
                ...
                @else
                    <div class="text-center py-5">
                        <div class="mb-3">
                            <i class="ph ph-users ph-4x text-gray-400"></i>
                        </div>
                        <h5 class="text-gray-500 mb-2">Tidak Ada Data Admin</h5>
                        <p class="text-gray-400 mb-4">Belum ada akun admin yang terdaftar dalam sistem.</p>
                        <a href="{{ route('admin.user_admin.create') }}" class="btn btn-main text-white rounded-pill px-24 py-12">
