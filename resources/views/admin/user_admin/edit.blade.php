<x-app-layout>
    ...
    <main>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.user_admin.update', $admin->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row g-20">
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control py-11 @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama', $admin->nama) }}" required>
                                @error('nama')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="email" class="form-control py-11 @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $admin->email) }}" required>
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                <select id="status" name="status" class="form-select py-11 @error('status') is-invalid @enderror" required>
                                    ...
                                    <option value="block" {{ old('status', $admin->status) == 'block' ? 'selected' : '' }}>Blokir</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control py-11 @error('status_message') is-invalid @enderror" id="status_message" name="status_message" value="{{ old('status_message', $admin->status_message) }}">
