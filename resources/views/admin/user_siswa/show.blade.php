<x-app-layout>
    ...
    <main>
        <div class="d-flex justify-content-between align-items-center mb-20">
            ...
            <div>
                <a href="{{ route('admin.user_siswa.edit', $siswa->id) }}" class="btn btn-warning text-white rounded-pill px-24 py-12 mx-2">
                    <i class="ph ph-pencil pr-3"></i>
                    {{ __('Edit') }}
                </a>
                <form action="{{ route('admin.user_siswa.destroy', $siswa->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus akun siswa ini?')">
                    @csrf
                    @method('DELETE')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="d-flex flex-column">
                            ...
                            <span class="h5 fw-semibold">{{ $siswa->email }}</span>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="d-flex flex-column">
                            <span class="text-gray-400 mb-2 fw-normal">Role</span>
                            <span class="h5 fw-semibold">Siswa</span>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="d-flex flex-column">
                    ...
                    @if($siswa->status_message)
                    <div class="col-md-6 mb-3">
                        <div class="d-flex flex-column">
                            <span class="text-gray-400 mb-2 fw-normal">Pesan Status</span>
                            <span class="h5 fw-semibold">{{ $siswa->status_message }}</span>
                        </div>
                    </div>
                    @endif
                    <div class="col-md-6 mb-3">
